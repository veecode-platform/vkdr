...
# V2 paths: relative to formulas/postgres/createdb/
...
source "$SHARED_DIR/lib/vault-tools.sh"
...
saveSecret() {
  ...
  #   sed "s/\${user_name}/$VKDR_ENV_POSTGRES_USER_NAME/g" "$SHARED_DIR/values/eso-crds-template.yaml" \
